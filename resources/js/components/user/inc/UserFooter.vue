	            	...
	            	<div class="row">
	            		...
	            		<div class="col-sm-4 col-lg-2">
	            			<div class="widget">
	            				...
	            				<ul class="widget-list">
	            					<li>
										<a href="/api/about">About Molla</a>
									</li>
	            					<li>
										<a href="/api/faq">How to shop on Molla</a>
									</li>
	            					<li>
	            		...
	            		<div class="col-sm-4 col-lg-2">
	            			<div class="widget">
	            				...
	            				<ul class="widget-list">
	            					<li>
										<router-link :to="{name: 'UserLogin'}">Sign In</router-link>
									</li>
	            					<li>
	            					...
	            					<li>
										<router-link :to="{name: 'MyAccount'}">Track My Order</router-link>
									</li>
	            					<li>
										<router-link :to="{name: 'Contact'}">Help</router-link>
									</li>
	            				</ul><!-- End .widget-list -->
	            			</div><!-- End .widget -->
