                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="logo pb-sm-30 pb-xs-30">
                                    <a href="index.html">
                                        <img src="/frontend/images/royalporter 1.png" alt="">
                                    </a>
                                </div>
                            </div>
                                        ...
                                        <li class="hm-minicart">
                                            ...
                                            <div class="minicart">
                                                <ul class="minicart-product-list">
                                                    <li>
                                                        <a href="javascript:void(0);" class="minicart-product-image">
                                                            <img src="/frontend/images/product/small-size/5.jpg" alt="cart products">
                                                        </a>
                                                        <div class="minicart-product-details">
                                                            <h6><a href="javascript:void(0);">Aenean eu tristique</a></h6>
                                                            <span>£40 x 1</span>
                                                        </div>
                                                ...
                                                <div class="minicart-button">
                                                    <router-link :to="{name: 'Cart'}" class="li-button li-button-fullwidth li-button-dark">
                                                        <span>View Full Cart</span>
                                                    </router-link>
                                                    <router-link :to="{name: 'Checkout'}" class="li-button li-button-fullwidth">
                                                        <span>Checkout</span>
                                                    </router-link>
                                                </div>
                                            </div>
                                        ...
                                        <ul>
                                            ...
                                            <li class="megamenu-holder"><a href="shop-left-sidebar.html">Shop</a>
                                                <ul class="megamenu hb-megamenu">
                                                    ...
                                                    <li><a href="javascript:void(0);">Single Products</a>
                                                        <ul>
