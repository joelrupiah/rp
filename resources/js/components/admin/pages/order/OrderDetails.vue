...
<h1><h6>Order ID: </h6><strong>{{ this.$route.params.order_id }}</strong></h1>
<!-- {{order}}/ -->
<div v-for="ord in order.product" :key="ord.id">
    <p>{{ ord.product.title }}</p>
</div>

<div class="container" v-for="ordr in order.shipping" :key="ordr.id">
    <p>{{ ordr.firstName }}</p>
</div>

<div class="container d-flex justify-content-center mt-50 mb-50 ml-5">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-transparent header-elements-inline">
                    <h6 class="card-title">Shopping invoice</h6>
                    <div class="header-elements"> 
                        <button type="button" class="btn btn-light btn-sm"><i class="fa fa-file mr-2"></i>
                            Save
                        </button> 
                        <button target="_blank" type="button" @click.prevent="printInvoice()" class="btn btn-light btn-sm ml-3"><i class="fa fa-print mr-2"></i> 
                            Print
                        </button> </div>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-lg">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <span>
                                        <img src="/uploads/invoice/chocolate1.jpg" alt=""
...
export default {
    ...
    methods: {
        getOrderDetail(){
            Api().get('/admin/order-details/'+this.$route.params.order_id)
                .then(response => {
